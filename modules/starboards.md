...
Pour créer un starboard par commande, il suffit de faire la commande <mark style="color:orange;">/config</mark> en sélectionnant "Starboards". Ensuite, cliquez sur "Créer", et DrafBot vous posera plusieurs afin de configurer au mieux votre premier starboard. 
