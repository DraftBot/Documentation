...
![Réponse de Draftbot lors de l'exécution de la commande](../.gitbook/assets/interserver_generate.png)
...
![Exemple de la commande à effectuer lors de la liaison des deux salons](../.gitbook/assets/interserver_link.png)
