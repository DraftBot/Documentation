...
Vous pouvez définir votre anniversaire via [le panel de Draftbot](https://www.draftbot.fr) ou avec la commande </anniversaire définir>. Il vous suffira de mettre dans l'argument `[date]` votre date d'anniversaire.
...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    - La première option du menu déroulant "Expérience", vous pouvez donner de l'[expérience](/autres/modules/niveaux) en cadeau à un membre.
    - La deuxième option du menu déroulant "Argent", vous permet de donner de l'[argent](/autres/modules/economie) au membre qui fêtera son anniversaire.
    - Grâce à la troisième option "Objet", vous pouvez donner un [objet d'inventaire](/autres/modules/economie#objets-dinventaire) à la personne qui fête son anniversaire.
  ...
  ::tab{ label="Depuis le panel" }
    Grâce au [panel de Draftbot](/dashboard/), vous pouvez paramétrer plusieurs options du système d'anniversaire.
    ...
    - Grâce à la troisième option "Objet d'inventaire", vous pouvez donner un [objet d'inventaire](/autres/modules/economie#objets-dinventaire) à la personne qui fête son anniversaire.
