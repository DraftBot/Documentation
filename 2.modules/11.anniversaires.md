...
![Exemple de commande d'anniversaire](/.assets/birthday/command_review.png){ height=93px }
...
![Message de confirmation de la commande /anniversaire activer](/.assets/birthday/birthday_enable.png){ height=145px }
