...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    ![Aperçu de la commande /config](/.assets/privateroom/config/view.png)
...
### Modifier un hub de salons vocaux temporaires
    ...
    ![Modification des Salons Vocaux Temporaires](/.assets/privateroom/config/view_edit.png)

<<<<<<< HEAD
   #### - Activer/Désactiver un Hub
=======
#### Activer/Désactiver un Hub
>>>>>>> d7bf168a7bb53815f24dd90f36f92ec3bb71bb48
...
>>>>>>> d7bf168a7bb53815f24dd90f36f92ec3bb71bb48
    ...
    Pour changer le salon vocal de redirection vers les salons temporaires, il suffira d'appuyer sur le bouton **Hub (salon)**. Vous devrez ensuite indiquer [l'identifiant du salon](/autres/recuperer-un-identifiant) de votre choix.
...
>>>>>>> d7bf168a7bb53815f24dd90f36f92ec3bb71bb48
    ...
    ::hint{ type="info" }
      Cette fonctionnalité est réservée aux [✨ serveurs premiums](/premium).
    ::

    Vous pourrez changer le nom par défaut des salons en appuyant sur le bouton `Nom des salons` et en écrivant simplement le nom que vous voulez. Il est recommandé **d'utiliser une [variable](#liste-des-variables)** afin de pouvoir distinguer 2 salons différents.
...
>>>>>>> d7bf168a7bb53815f24dd90f36f92ec3bb71bb48
  ...
  ::tab{ label="Via le panel" }
    ...
    ![Vue de l'onglet communauté](/.assets/privateroom/panel/view_panel.png)
...
### Créer un Hub
    ...
    Pour créer un hub, il suffit de cliquer sur le bouton "**Créer un hub**". Il y aura une liste d'informations à remplir, qui seront mentionnées dans la partie [**Modifier un Hub**](#modifier-un-hub).
...
### Modifier un Hub
    ...
    ![Modification de Hub](/.assets/privateroom/panel/view_edit.png)
...
### Changer le format des noms du salon
    ...
    Afin d'éviter des salons dit doublons, il est conseillé d'indiquer au moins une **[variable](#liste-des-variables)**.
...
### Supprimer un Hub
    ...
    Pour supprimer un hub, il vous suffit d'aller dans la partie **Salons vocaux privés** du [panel Draftbot](/dashboard/first/community) et de **supprimer** le hub de votre choix.
    ...
    ::hint{ type="danger" }
      ...
      ![Message de confirmation](/.assets/privateroom/panel/view_delete.png)
    ::
...
![Illustration du configurateur](/.assets/privateroom/view_embed.png)
...
::hint{ type="danger" }
  ...
  Notez que vous perdrez l'accès à l'embed de configuration du **[salon vocal](#utilisation-du-configurateur-de-salon)**.
::
