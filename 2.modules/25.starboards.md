...
### Réaction
  ...
  #### Émoji 
  - Cette option vous **permet de modifier l'émoji par default du starboard. [premium ✨](https://www.draftbot.fr/premium/) !**
...
### Rôles
  ...
  - Grâce à cette option, vous pouvez **définir que, seulement, les messages d'un groupe d'utilisateur *(via des rôles)* puissent apparaitre dans le starboard**.
