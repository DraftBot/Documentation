...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    ![La configuration via /config](/.assets/starboards/config_example.png)
...
### Message via un Embed

![Exemple avec Embed](/.assets/starboards/example_embed.png)

### Message sans Embed

![Exemple sans Embed](/.assets/starboards/example.png)
