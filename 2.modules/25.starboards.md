...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    Vous pouvez notament définir le salon du starboard, et le nom.
    La personnalisation de l'emoji est néanmoins réservée aux serveurs [premium](https://www.draftbot.fr/premium/).
