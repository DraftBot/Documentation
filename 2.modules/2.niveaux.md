...
::tabs
  ::tab{ label="Commande /config" }
    PPour configurer les récompenses de niveaux sur Discord, utilisez la commande /config, accédez à l'onglet "Niveaux" puis sélectionnez "Récompenses de niveaux".
