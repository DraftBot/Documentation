...
::hint{ type="info" }
Pour pouvoir obtenir de l'argent, il vous faut [__configurer__](/docs/modules/economie#configuration) le système d'économie.
::
...
::hint{ type="info" }
Le marché noir est une variante de la boutique consistant à se supprimer au bout de 60 secondes d'inactivité, ni vu ni connu ! Plus d'informations [__ici__](/docs/modules/economie#type-de-la-boutique).
