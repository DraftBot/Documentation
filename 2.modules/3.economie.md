...
Vous avez la possibilité avec **DraftBot** de pouvoir animer la vie de votre serveur avec des objets d'inventaire. Une fois achetés dans la __[boutique](/docs/modules/economie#boutique)__ ou gagnés, vous pouvez exécuter des commandes qui vous permettront **d'effectuer des échanges** entre membres et **la gestion des inventaires** !
