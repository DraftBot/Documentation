...
![Carte d'économie](/.assets/economy/money.png){ height=220px }
...
::hint{ type="info" }
Pour pouvoir obtenir de l'argent, il vous faut configurer [__configurer__](/docs/modules/economie#configuration) le système d'économie.
::
...
::hint{ type="info" }
Le marché noir est une variante de la boutique consistant à se supprimer au bout de 60 secondes d'inactivité, ni vu ni connu ! Plus d'informations [__ici__](/docs/modules/economie#typedelaboutique).
...
Vous avez la possibilité avec __DraftBot__ de pouvoir animer la vie de votre serveur avec des objets d'inventaire. Une fois achetés dans la __[boutique](/docs/modules/economie#boutique)__ ou gagnés, vous pouvez exécuter des commandes qui vous permettront __d'effectuer des échanges__ entre membres et __la gestion des inventaires__ !
...
- [Le système d'économie](/docs/modules/economie#systeme-deconomie)
- [La configuration de la boutique](/docs/modules/economie#configuration-de-la-boutique)
