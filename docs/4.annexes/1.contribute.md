...
ChaToutes les pages de la documentation *(hormis certaines pages)* doivet définir une icône via `navigation.icon`.

Deux bibliothèques d'icônes sont utilisées :

- **Les [`twemoji`](https://icones.js.org/collection/twemoji) :** **Uniquement** pour les **[pages de modules](/docs/modules)** et les pages **d'accueil/installation**.
