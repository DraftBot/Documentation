---
title: 'Page de référence de PatocheBot'
...
redactors: ['draftproducts', 'rababio4579', 'patochedev']
contributors: ['clement669', 'iibey', 'imroxxor', 'patochedev']
noindex: false
---

## Style d'écriture

La documentation est une partie essentielle de **PatocheBot**, elle permet à chaque utilisateur d'avoir une bonne expérience et utilisation du bot. Il est important qu'il puisse trouver des réponses à ses questions de manière simple et en autonomie.
