...
Vous avez la possibilité de désactiver les avantages premium sur un serveur où vous l'avez activé. Pour ce faire, vous avez deux possibilités.
    ...
    ::hint{ type="info" }
      Si vous quittez un serveur sur lequel votre premium est actif, les avantages ne seront pas retirés automatiquement.

      Pour y mettre fin, vous devez désactiver le premium manuellement via le panel ou la commande </premium desactiver>.
    ::
