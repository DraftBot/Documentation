...
| `{level.next_user.level}` | Niveau du membre précédent dans le classement | 27 |
| `{level.next_user.level_diff}` | Différence de niveaux avec le membre précédent dans le classement | 2 |
| `{level.next_user.xp}` | Quantité d'expérience du membre précédent dans le classement | 15 000 |
| `{level.next_user.xp_diff}` | Différence d'expérience avec le membre précédent dans le classement | 2 500 |
