...
| `{money.next_user_money}` | Différence d'argent avec le membre précédent dans le classement | 500 |
...
| `{xp.next_user}` | Membre précédent dans le classement | @Username |
| `{xp.next_user_xp}` | Différence d'expérience avec le membre précédent dans le classement | 1 500 |
| `{xp.next_user_level}` | Différence de niveaux avec le membre précédent dans le classement | 2 |
