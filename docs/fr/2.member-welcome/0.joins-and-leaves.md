...
![Exemple de message de bienvenue](./assets/joins-and-leaves/bot_welcome.png)
...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    ![Activer le système de bienvenue](./assets/joins-and-leaves/panel_welcome_enable.png)

    ::hint{type="warning"}
      Une fois fini, n'oubliez pas d'enregistrer vos modifications avec le bouton "Enregistrer" en bas de la page.
    ::

    ![Menu de configuration](./assets/joins-and-leaves/panel_welcome.png)
  ::
  ...
  ::tab{ label="Via la commande /config" }
    ...
    ::hint{ type="info" }
      ...
      ![Menu de sélection de la couleur de fond](./assets/joins-and-leaves/config_welcome_color.png)
    ::
    ...
    ![Menu de configuration du système de bienvenue](./assets/joins-and-leaves/config_welcome.png)
  ::
::
...
![Exemple de message d'au revoir](./assets/joins-and-leaves/bot_goodbye.png)
...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    ![Activer le système messages d'au revoir](./assets/joins-and-leaves/panel_goodbye_enable.png)

    ::hint{type="warning"}
      Une fois fini, n'oubliez pas d'enregistrer vos modifications avec le bouton "Enregistrer" en bas de la page.
    ::

    ![Menu de configuration](./assets/joins-and-leaves/panel_goodbye.png)
  ::
  ...
  ::tab{ label="Via la commande /config" }
    ...
    ::hint{ type="info" }
      ...
      ![Menu configuration couleur de fond](./assets/joins-and-leaves/config_goodbye_color.png)
    ::
    ...
    ![Menu de configuration du système d'au revoir](./assets/joins-and-leaves/config_goodbye.png)
  ::
::
