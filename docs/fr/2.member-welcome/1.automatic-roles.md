---
slug: /accueil-des-membres/roles-automatiques
...
::tabs
  ...
  ::tab{ label="Via la commande /config" }
    ...
    ::hint{ type="info" }
      Vous pouvez créer jusqu'à 3 rôles automatiques. Les serveurs [premium](/premium) <:icon_premium:1096140508625125417> ont le droit d'en créer jusqu'à 10.
    ::
