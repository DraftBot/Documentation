...
![Aperçu du système](./assets/word-reactions/bot_example.png)
...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    ![Aperçu du panel](./assets/word-reactions/panel_view.png)
    ...
    ![Restriction de rôle](./assets/word-reactions/panel_roles_restrict.png)
  ...
  ::tab{ label="Via la commande /config" }
    ...
    ![Configuration via /config](./assets/word-reactions/config_view.png)
    ...
    ![Aperçu du message](./assets/word-reactions/config_creation_question.png)
