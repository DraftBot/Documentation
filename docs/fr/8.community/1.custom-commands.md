---
slug: /communaute/commandes-personnalisees
...
::hint{ type="info" }
  Vous pouvez créer jusqu'à **20 commandes personnalisées**. Les serveurs [premium](/premium) <:icon_premium:1096140508625125417> peuvent en créer jusqu'à **100**.
::
...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    ![Panel de configuration des commandes personnalisées](./assets/custom-commands/panel_view.png)
    ...
    ::hint{ type="info" }
      ...
      ![Boutons de modification ou suppression d'une commande personnalisée](./assets/custom-commands/panel_edit_command.png)
    ::
  ::
  ...
  ::tab{ label="Message" }
    ...
    *Lors de l'exécution de la commande, DraftBot enverra un message.*
    ...
    ::collapse{ label="Afficher un exemple :" }
      ...
      ![Exemple d'action Envoyer un Message, avec Embed et variables](./assets/custom-commands/panel_action_send_message.png)

      À l'exécution de la commande, voici ce qu'on obtient :

      ![Résultat de la commande sur Discord](./assets/custom-commands/panel_sent_message_example.png)
    ::
  ::
    ...
    1. **Ajouter des rôles**
        ...
        *Lors de l'exécution de la commande, DraftBot attribuera le/les rôles sélectionnés.*
        ...
        ::collapse{ label="Afficher un exemple :" }
          ...
          ![Exemple d'action Ajouter des rôles](./assets/custom-commands/panel_action_add_role.png)
    ...
    2. **Ajouter un rôle temporaire**
        ...
        *Lors de l'exécution de la commande, DraftBot attribuera un rôle, puis le retirera après un temps de votre choix.*
        ...
        ::collapse{ label="Afficher un exemple :" }
          ...
          ![Exemple d'action Ajouter des rôles](./assets/custom-commands/panel_action_add_temprole.png)
    ...
    3. **Retirer des rôles**
        ...
        *Lors de l'exécution de la commande, DraftBot retirera le/les rôles sélectionnés.*
        ...
        ::collapse{ label="Afficher un exemple :" }
          ...
          ![Exemple d'action Retirer des rôles](./assets/custom-commands/panel_action_remove_role.png)
        ...
        ::hint{ type="info" }
          ...
          ![Cibler un autre membre](./assets/custom-commands/panel_target_mentionned_member.png)
        ::
  ::
    ...
    1. **Article de la boutique**
        ...
        *En utilisant cette commande, le membre achètera l'objet sélectionné.*
        ...
        ::collapse{ label="Afficher un exemple :" }
          ...
          ![Exemple d'action Article de la boutique](./assets/custom-commands/panel_action_buy_article.png)
    ...
    2. **Ajouter de l'argent**
        ...
        *Lors de l'exécution de la commande, DraftBot ajoutera un montant défini d'argent au membre.*
        ...
        ::collapse{ label="Afficher un exemple :" }
          ...
          ![Exemple d'action Ajouter de l'argent](./assets/custom-commands/panel_action_add_money.png)
...
::tabs
  ::tab{ label="Depuis le panel" }
    ::hint{ type="info" }
      ...
      ![Développer le menu des options avancées](./assets/custom-commands/panel_advanced_button.png)
    ::
  ::
...
::tabs
  ::tab{ label="Restrictions" }
    ...
    2. **Restreindre par Salons**
        ...
        ::hint{ type="info" }
          ...
          ![Dans cette configuration, si j'ajoute des rôles/salons, ils n'auront pas accès à la commande.](./assets/custom-commands/panel_channels_roles_restrict.png)
        ::
  ::
  ...
  ::tab{ label="Masquage" }
    ...
    ![Option permettant de cacher la commande](./assets/custom-commands/panel_command_hidden.png)
  ...
  ::tab{ label="Mode lent" }
    ...
    ![Le Panel offre une interface intuitive pour régler le mode lent. ](./assets/custom-commands/panel_cooldown.png)
    ...
    ::hint{ type="success" }
      ...
      ![Réinitialiser son mode lent depuis le panel](./assets/custom-commands/panel_reset_cooldown.png)
    ::
  ::
  ...
  ::tab{ label="Conditions" }
    ...
    ::hint{ type="success" }
      ...
      ![Liste des conditions possibles](./assets/custom-commands/panel_conditions.png)
    ::
  ::
::
