...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    ::hint{ type="info" }
      Vous pouvez configurer une réaction pour 10 mots. Les serveurs [premium](/premium) <:icon_premium:1096140508625125417> peuvent avoir jusqu'à 5 réactions pour un même mot, et configurer jusqu'à 1 000 mots.
    ::
