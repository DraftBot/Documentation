---
slug: /accueil-des-membres/arrivees-et-departs
...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    [⫸ Accéder au panel de **DraftBot**](/dashboard/first/welcome)
  ...
  ::tab{ label="Via la commande /config" }
    ...
    ::collapse{ label="Variables" }
      ...
      - `{server.humancount}` ➜ Nombre d'humain sur le serveur
    ...
    ::hint{ type="info" }
      ...
      Si vous souhaitez avoir une couleur personnalisée, vous devez souscrire à un abonnement [premium](/premium) <:icon_premium:1096140508625125417>.
