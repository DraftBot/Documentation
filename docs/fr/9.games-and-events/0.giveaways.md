---
slug: /jeux-et-evenements/giveaways
title: Giveaways
...
- De l'expérience dans le système de [niveaux](/docs/engagement/niveaux).
- De l'argent dans le système d'[économie](/docs/engagement/economie).
- Un objet provenant du système d'[inventaire](/docs/engagement/inventaire).
...
Néanmoins, vous pouvez ouvrir cette commande à certains rôles ou à certains membres, indépendamment de leurs permissions sur le serveur.
...
|--------|-------------|-------------|
| `type` | Le [type de récompense](#présentation). | ✅ Oui |
| `durée` | La durée du giveaway comprise entre une minute et un mois (ex : 2h, 7j) ou une date (ex : demain à 17h). | ✅ Oui |
| `gagnants` | Le nombre de gagnants compris entre 1 et 10 (jusqu'à 50 pour les serveurs [premium](/premium) <:icon_premium:1096140508625125417>). | ✅ Oui |
| `titre` | Le titre du giveaway. | ❌ Non |
| `salon` | Le salon où sera envoyé le giveaway : salon textuel, salon d'annonces ou fil de discussion. | ❌ Non (par défaut le salon de la commande) |

::hint{ type="info" }
  Vous pouvez lancer jusqu'à 3 giveaways en simultané. Les serveurs [premium](/premium) <:icon_premium:1096140508625125417> n'ont pas de limite.
::
...
Vous avez la possibilité de sélectionner l'**une de ces récompenses** pour un giveaway :
...
::hint{ type="info" }
  Vous pouvez choisir jusqu'à 10 gagnants. Les serveurs [premium](/premium) <:icon_premium:1096140508625125417> peuvent aller jusqu'à 50 gagnants.
::
...
::hint{ type="warning" }
  Le créateur du giveaway et <@DraftBot> doivent disposer des permissions **Envoyer des messages** et **Voir le salon**. <@DraftBot> doit également disposer des permissions **Intégrer des liens**, **Ajouter des réactions** et **Voir les anciens messages** dans ce salon, ainsi que de la permission **Gérer les rôles** sur le serveur pour attribuer les récompenses de type rôle.
::
...
|-----------|-------------|
| [Objet](/docs/engagement/inventaire) | Posséder un objet, avec possibilité de le retirer. |
| [Niveau](/docs/engagement/niveaux) | Niveau minimum ou maximum requis. |
| [Argent](/docs/engagement/economie) | Quantité d'argent minimum ou maximum nécessaire, avec possibilité de faire payer la somme. |
| Rôles | Posséder (ou non) un ou plusieurs rôles, avec possibilité de les retirer. |
...
::hint{ type="info" }
  Cette option est réservée aux serveurs [premium](/premium) <:icon_premium:1096140508625125417>.
::
...
Pour désigner un nouveau gagnant sur un giveaway terminé, vous pouvez utiliser la commande \</giveaway relancer>, en indiquant l'[identifiant](/docs/autres/recuperer-un-identifiant#identifiant-dun-message) ou le lien du message du giveaway.
