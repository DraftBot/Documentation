...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    ![Configuration des rôles automatiques à l'arrivée sur le panel](./assets/automatic-roles/panel_join.png)
  ::
  ...
  ::tab{ label="Via la commande /config" }
    ...
    ![Menu d'accueil de la configuration des rôles automatiques à l'arrivée](./assets/automatic-roles/config_join.png)
  ::
::
...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    ![Configuration des rôles automatiques de vocal, sur le panel](./assets/automatic-roles/panel_voice.png)
  ::
  ...
  ::tab{ label="Via la commande /config" }
    ...
    ![Menu d'accueil de la configuration des rôles automatiques en vocal](./assets/automatic-roles/config_voice.png)
  ::
::
...
::tabs
  ::tab{ label="/role tous" }
    ...
    ![Exemple de la commande](./assets/automatic-roles/config_roles_all.png)
    ...
    ![Suivi de la tâche](./assets/automatic-roles/config_roles_progress.png)
  ...
  ::tab{ label="/role pour" }
    ...
    ![Exemple de la commande](./assets/automatic-roles/config_roles_to.png)
