...
![Résultat de la commande /reglement créer](./assets/rules/bot_rules_1.png)
...
![Aperçu de la commande /reglement ajouter](./assets/rules/config_rules_add.png)
...
![Résultat d'ajout d'une règle](./assets/rules/bot_rules_2.png)
...
![Aperçu de la commande /reglement modifier](./assets/rules/config_rules_edit.png)

![Résultat de la modification d'une règle](./assets/rules/bot_rules_3.png)
...
::hint{ type="info" }
  ...
  ![Aperçu du panel dans la catégorie Messages](./assets/rules/panel_messages.png)
::
...
![Aperçu de la commande /reglement retirer](./assets/rules/config_rules_remove.png)
