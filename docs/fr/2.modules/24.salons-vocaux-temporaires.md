...
contributors: ['tellvex', 'kazotka', 'theorik', 'elbaguetto', 'thecreatorn3ant', 'imroxxor']
...
::tabs
  ...
  ::tab{ label="Via le panel" }
    ...
    Pour supprimer un hub, il vous suffit d'aller dans la partie **Salons vocaux privés** du [panel de DraftBot](/dashboard/first/community) et de **supprimer** le hub de votre choix.
