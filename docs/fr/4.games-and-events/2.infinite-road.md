...
![Exemple](../assets/route-infini/message_counting.png)
...
![Exemple avec discussion](../assets/route-infini/message_counting_discussion.png)
...
![Interface de la Route de l'Infini](../assets/route-infini/bot_infiniteroad_command.png)
...
![Affichage d'une récompense mystère via la commande /route-infini](../assets/route-infini/bot_mystery_gift.png)
...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    ![Options de masquage dans la configuration d'une récompense sur le panel](../assets/route-infini/panel_hide_elements.png)
  ...
  ::tab{ label="Via la commande /route-infini" }
    ...
    ![Bouton "Éléments masqués" lors de la modification d'une récompense](../assets/route-infini/config_hide_elements.png)
  ::
::
...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    ![Configuration du message de réinitialisation sur le panel](../assets/route-infini/panel_reset_message.png)
  ::
  ...
  ::tab{ label="Via la commande /config" }
    ...
    ![Réponse de DraftBot après avoir appuyé sur le bouton "Message de réinitialisation"](../assets/route-infini/bot_reset_message.png)
  ::
::
