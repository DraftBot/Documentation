...
::hint{ type="info" }
  Depuis le [panel web](/dashboard/user/premium), vous avez le choix d'activer le **Renouvellement automatique**. Celui-ci vous permettra de payer automatiquement chaque mois après l'activation de votre code. Vous aurez le choix parmi les différentes [formules disponibles](/premium).
::
