...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    ![Aperçu d'un rôle à risque](./assets/secure-roles/panel_risky_roles.png)
  ::

  ::tab{ label="Via la commande /config" }
    ![Menu de configuration des rôles sécurisés](./assets/secure-roles/config_menu.png)
  ::
::
...
::hint{ type="info" }
  Si le premium prend fin alors que plus de deux rôles sont configurés, les configurations excédentaires — les plus récentes — sont **désactivées** et les accès qu'elles portent sont coupés. Rien n'est supprimé : elles sont conservées telles quelles, durées comprises, et reprendre le premium les réactive à l'identique. La désactivation comme la réactivation sont signalées dans vos [logs](/docs/securite/logs).
::
...
![Aperçu de l'interface pour sécuriser un rôle](./assets/secure-roles/panel_risky_role_setup.png)
...
![Aperçu du menu secure-roles connecté](./assets/secure-roles/bot_connected.png)
...
![Panel sécurité via le panel](./assets/secure-roles/panel_security.png)
...
::tabs
  ::tab{ label="Clé d'accès" }
    ![Configuration de la sécurité par clé d'accès](./assets/secure-roles/panel_passkeys.png)
  ...
  ::tab{ label="Application d'authentification" }
    ![Configuration de la sécurité par application d'authentification](./assets/secure-roles/panel_security_2fa.png)
  ...
  ::tab{ label="Code PIN" }
    ![Configuration de la sécurité par code PIN](./assets/secure-roles/panel_security_pin.png)

    Les codes trop prévisibles *(123456, 000000)* sont refusés.
  ::

  ::tab{ label="Mot de passe" }
    ![Configuration de la sécurité par mot de passe](./assets/secure-roles/panel_security_password.png)
  ::
::
...
![Section accès des membres](./assets/secure-roles/panel_role_access.png)
...
![Historique des sessions](./assets/secure-roles/panel_history.png)
