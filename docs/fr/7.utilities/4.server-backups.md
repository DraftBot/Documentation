...
![Panel de confirmation](./assets/server-backups/bot_create.png)
...
![Liste de toutes les sauvegardes effectuées](./assets/server-backups/bot_list.png)
...
![Image de l'avertissement pour expliquer que la communauté doit être désactivée](./assets/server-backups/bot_warncommunity.png)
...
::
![Confirmation de la suppression d'une sauvegarde](./assets/server-backups/bot_delete_confirmation.png)
...
![Le panel de confirmation de réinitialisation](./assets/server-backups/bot_reset_confirmation.png)
