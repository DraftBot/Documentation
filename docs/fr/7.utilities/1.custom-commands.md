---
slug: /utilitaires/commandes-personnalisees
...
::tabs
  ...
  ::tab{ label="Via la commande /config" }
    ...
    - La / les [actions](#les-actions) que votre commande devra réaliser,
    - Les rôles ou salons [autorisés/interdits](#options-avancées),
    - Si la commande doit [apparaître](#options-avancées) dans le \</aide> ou non,
    - Si vous souhaitez ajouter un [mode lent](#options-avancées) à votre commande,
    - Si vous souhaitez définir une [condition](#options-avancées) pour l'utiliser.
...
**Fonctionnalités :**
- Support des [modificateurs](#les-variables) : `{args.1?uppercase}`
