---
slug: /communication/salons-de-statistiques
...
redactors: ['imroxxor']
contributors: ['iibey', 'rababio4579', 'lyvendev']
...
![Aperçu d'un salon vocal de statistiques](./assets/statistics-channels/bot_vocalcount.png)

### Catégorie

![Aperçu d'une catégorie de statistiques](./assets/statistics-channels/bot_categorycount.png)
...
::tabs
  ::tab{ label="Depuis le panel" }
    [⫸ Accéder au panel de **DraftBot**](/dashboard/first/stats-channels)
...
- **L'URL de l'API** : par exemple `https://api.draftbot.fr/base/stats`
- **Chemin vers la valeur numérique :** par exemple `guilds`
