...
Chaque type de log peut être configuré pour être envoyé vers un autre serveur ou une API externe.
...
Il est également possible d'envoyer les logs vers une autre destination.
...
![Menu qui apparaît lors de la modification d'un webhook](../assets/logs/server_webhook_section.png)
