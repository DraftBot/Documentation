...
- **[API Externe](/docs/modules/salons-de-statistiques#api-personnalis%C3%A9e)** : l'URL de votre choix, appelée en **HTTP POST** au format JSON, avec jusqu'à **3 headers** pour transmettre par exemple une clé d'authentification.
