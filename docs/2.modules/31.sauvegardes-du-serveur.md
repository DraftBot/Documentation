...
Vous aurez à disposition l'option `sauvegarde` qui permet de sélectionner la sauvegarde à restaurer.

## Supprimer une sauvegarde

La commande \</sauvegarde retirer> permet de supprimer une sauvegarde spécifique. Elle ne dispose que d'une seule option nommée `sauvegarde` qui permet de sélectionner la sauvegarde à supprimer.
