...
::hint{ type="success" }
  ...
  Le système d'économie peut être lié aux autres fonctionnalités DraftBot (comme les **[commandes personnalisées](/docs/modules/commandes-personnalisees), l'[inventaire](/docs/modules/inventaire), les [anniversaires](/docs/modules/anniversaires), les [niveaux](/docs/modules/niveaux)** ...).
::
...
::tabs
  ...
  ::tab{ label="Via la commande /config" }
    ...
    ![Module économie via la commande /config](../assets/economie/)
    Le message vous permet de consulter en un coup d'oeil l'état actuel de votre système économique, tandis que les boutons situés au dessous vous permettent d'en modifier la configuration. Voici le détail de chaque bouton :
    ...
    ::
    ::collapse{ label="Limitiations & Boosts" }
