...
::hint{ type="info" }
  Les serveurs [premium](/premium) <:icon_premium:1096140508625125417> peuvent **personnaliser cette intervalle** indépendamment de celui du vocal.
::
...
::hint{ type="info" }
  Cette intervalle est également **personnalisable** indépendamment de celui des messages.
::
