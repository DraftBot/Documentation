...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    ![Activation du système d'économie depuis le Panel](../assets/economie/dashboard_activate_system.png)
...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    ![Bouton de création de boutique depuis le panel](../assets/economie/bouton_boutique.png)

    Une fenêtre s'ouvre pour configurer votre nouvelle boutique :

    ![Menu de création de boutique](../assets/economie/accueil_boutique_panel.png)
...
::hint{ type="info" }
  Vous pouvez créer jusqu'à **1 boutique** gratuitement. Les serveurs [premium](/premium) peuvent en créer jusqu'à 5.
::
...
![Bouton d'importation de l'économie](../assets/economie/import_economy.png)
