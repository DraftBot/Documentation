...
::tabs
  ...
  ::tab{ label="Via la commande /config" }
    ...
    ::collapse{ label="Argent" }
      ...
      - Activer / Désactiver le gain d'argent[^1] dans les fils,
      - Activer / Désactiver le gain d'argent[^1] par message en vocal,
      - Activer / Désactiver/ Régler les gains x2 pour les messages longs,
      - Choisir si l'argent[^1] des membres quittant le serveur est remis à 0.
    ...
    ::collapse{ label="Limitations & Boosts" }
      ...
      - Définir quels rôles ne sont pas autorisés à gagner d'argent[^1],
      - Définir quels salons ne sont pas autorisés à gagner d'argent[^1],
...
::collapse{ label="Afficher / masquer la liste de fonctionnalités" }
  ...
  |     **NOM**    | **EXPLICATION** ||
  |------------|-------------|-|
  |**Argent[^1] par message**|Modifier ou désactiver la somme gagnée à chaque message envoyé||
  |**Argent[^1] de départ**|Modifier la somme de base reçue en rejoignant le serveur ||
  |**Rôles avec/sans gain d'argent[^1]**|Restreindre le gain d'argent[^1] à certains rôles||
  ...
  |**Argent[^1] pour 2 minutes  en vocal**|Définir la somme gagnée en vocal|<:icon_premium:1096140508625125417>|
  |**Argent[^1] quotidien**|Régler la somme réclamable chaque jour via \</journalier>|
  |**Salons avec/sans gain d'argent[^1]**|Restreindre le gain d'argent[^1] à certains salons|
...
::collapse{ label="Afficher / masquer la liste des options" }
  ...
  |     **NOM**    | **EXPLICATION** ||
  |------------|-------------|-|
  |**Gain d'argent[^1] dans les fils de discussions**|Autoriser ou non les membres à gagner de l'argent[^1] dans les fils||
  ...
  |**Réinitialisation argent[^1]**|Définir si les membres perdent leur argent[^1] en quittant le serveur||
  |**Gain d'argent[^1] par message en vocal**|Définir si les messages textuels envoyés dans les salons vocaux rapportent de l'argent[^1] ou non||
...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    ![Menu de la boutique depuis le panel](../assets/economie/economie/accueil_boutique_panel.png)
...
- \</dropargent>  : Crée un message qui offre une somme d'argent[^1] au premier qui clique sur le bouton,
- \</argent>      : Permet d'afficher la quantité d'argent[^1] que vous, ou un autre membre, possédez,
- \</payer>       : Donner de son argent[^1] au membre ciblé,
...
- \</adminargent ajouter>       : Ajouter de l'argent[^1] à un membre,
- \</adminargent retirer>       : Retirer de l'argent[^1] à un membre,
- \</adminargent réinitialiser> : Réinitialiser l'argent[^1] de tout le serveur,
- \</adminargent définir>       : Définir l'argent[^1] d'un membre,
- \</adminargent transférer>    : Transférer de l'argent[^1] d'un membre à un autre.
...
[^1]: Il s'agit bien sûr de la devise fictive de votre serveur, pas d'argent réel.
