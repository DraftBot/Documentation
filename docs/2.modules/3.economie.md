...
contributors: ['bariboo', 'clement669', 'theorik', 'ls62', 'rababio4579']
...
Les serveurs [premium](/premium) pourront profiter d'un gain d'argent en fonction de l'**activité vocale** : Chaque membre en vocal considéré comme actif, gagnera une quantité d'argent comprise entre deux valeurs configurées (15 à 25 💰 par défaut) toutes les 2 minutes.
