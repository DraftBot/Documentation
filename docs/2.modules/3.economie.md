...
::hint{ type="info" }
  ...
  - Si vous êtes abonné [<:icon_premium:1096140508625125417>DraftBot premium](/premium), vous pouvez le modifier pour créer des articles en quantité limitée !
...
::hint{ type="info" }
  Il est également possible d'entrer dans le menu de création d'objet depuis la section [**Niveaux** du Panel DraftBot](/dashboard/first/economy) !
::
