...
::hint{ type="info" }
  Les fonctionnalités ou options accompagnées du symbole <:icon_premium:1096140508625125417> sont réservées aux serveurs [premium](/premium) <:icon_premium_:1096140508625125417>.
  .
::
...
::hint{ type="info" }
  ...
  - Si le serveur est [premium](/premium) <:icon_premium_:1096140508625125417>, vous pouvez le modifier pour créer des articles en quantité limitée !
