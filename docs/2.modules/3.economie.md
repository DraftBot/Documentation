...
::hint{ type="info" }
  Les serveurs [premium](/premium) <:icon_premium:1096140508625125417> peuvent **personnaliser cet intervalle**, de **5 secondes à 1 heure**, indépendamment de celui du vocal.
::

### Argent en vocal

Les serveurs [premium](/premium) <:icon_premium:1096140508625125417> peuvent activer le gain d'argent en fonction de l'**activité vocale**. Chaque membre actif en vocal gagne une quantité d'**argent aléatoire** (15 à 25 💰 par défaut, configurable) mais aussi pour une **durée aléatoire** (toute les 2 minutes par défaut, configurable).

::hint{ type="info" }
  Cet intervalle est également **personnalisable**, de **5 secondes à 1 heure**, indépendamment de celui des messages.
::
...
::hint{ type="info" }
  Les serveurs [premium](/premium) <:icon_premium_:1096140508625125417> peuvent utiliser des valeurs personnalisées qui vont de x0.1 à x10.
::
