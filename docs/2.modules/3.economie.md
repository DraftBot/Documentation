...
::tabs
  ...
  ::tab{ label="Via la commande /config" }
    ...
    ::
    ::hint{ type="info" }
      Les fonctionnalités accompagnées du symbole <:icon_premium:1096140508625125417> sont réservées aux abonnés [✨DraftBot premium](https://www.draftbot.fr/premium)
    ::
  ::
::
