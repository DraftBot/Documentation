...
| Option | Description |  |
|--------|-------------|--|
| **Gain d'argent par message en vocal** | Vous avez le choix entre 3 modes. Vous pouvez choisir avec le mode **tout le monde** que tous les utilisateurs qui envoient des messages, connectés ou non, gagnent de l'argent en écrivant. Lorsque l'option **seulement si connecté(e) au vocal** est activée, les messages textuels envoyés dans les salons vocaux rapportent de l'argent **uniquement si le membre est connecté en vocal** dans ce même salon. Si elle est désactivée, aucun message textuel dans les salons vocaux ne rapporte d'argent. |  |
