...
![Message de signalement](../assets/reports/report.png)
...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    ![Aperçu du système](../assets/reports/config-report.png)
  ...
  ::tab{ label="Via le panel" }
    ...
    ![Panel de configuration des niveaux](../assets/reports/dashboard.png)
  ::
::
