...
contributors: ['tellvex', 'kicoulapic314', 'theorik', 'erwangit', 'ls62', 'thecreatorn3ant', 'elbaguetto', 'imroxxor', 'draftproducts']
...
::hint{ type="info" }
  Vous pouvez avoir jusqu'à **une seule chaîne [YouTube](https://www.youtube.com/) différente**. Les serveurs [premium](/premium) <:icon_premium_:1096140508625125417> peuvent en avoir jusqu'à 5.
::
...
::hint{ type="info" }
  Vous ne pouvez configurer qu'une seule notification [Reddit](https://www.reddit.com/) au maximum. Les serveurs [premium](/premium) <:icon_premium_:1096140508625125417> étendent leur limite jusqu'à 10.
::
