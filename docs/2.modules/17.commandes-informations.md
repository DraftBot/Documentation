...
## /info émoji
La commande \</info émoji> vous permet d'obtenir les informations détaillées sur les émojis du serveur auquel votre commande est lancée. Vous pourrez connaitre :
- Son identifiant.
- Sa mention.
...
![Aperçu de la commande /info émoji](../assets/commandes-informations/commande_info_emojis.png)
