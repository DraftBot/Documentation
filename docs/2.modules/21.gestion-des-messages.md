...
redactors: ['titoto289']
contributors: ['sagipierre', 'iibey', 'theorik', 'ls62', 'rababio4579', 'imroxxor', 'kicoulapic314']
...
::hint{ type="warning" }
  **DraftBot** peut déplacer un ou des messages uniquement s'il dispose des permissions "_Gérer les webhooks_" et "_Gérer les messages_" sur votre serveur.
::
...
Vous pouvez sauvegarder une conversation avec la commande \</sauvegarder conversation>.
