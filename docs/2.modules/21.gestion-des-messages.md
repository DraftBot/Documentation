...
Vous pouvez sauvegarder une conversation avec le slash commande \</enregistrer conversation>.
...
::hint{ type="warning" }
  **DraftBot** peut sauvegarder une conversation uniquement s'il dispose de la permission "*Gérer les messages*" sur votre serveur.
::
