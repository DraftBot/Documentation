...
::tabs
  ...
  ::tab{ label="/role pour" }
    La commande \</role pour> à une fonction à peu près similaire mais permet de cibler plus précisement des membres. Le principe est le même, choisir le type d'action et le rôle concerné, mais vous devez choisir le rôle qui fera office de condtion
