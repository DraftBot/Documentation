...
contributors: ['bariboo', 'iibey', 'titoto289', 'theorik', 'imroxxor', 'draftproducts']
...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    ::hint{ type="info" }
      Vous pouvez créer jusqu'à 3 rôles automatiques. Les serveurs [premium](/premium) <:icon_premium_:1096140508625125417> ont de droit d'en créer jusqu'à 10.
    ::
