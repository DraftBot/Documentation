...
::hint{ type="info" }
  Le calendrier de l'avent est configurable du 25 novembre au 25 décembre.
::
...
- La série peut se poursuivre **d'une année sur l'autre** (la case du 24 décembre suivie de la case du 1er décembre maintient la série)
