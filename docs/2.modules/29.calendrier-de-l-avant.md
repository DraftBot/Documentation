...
::hint{ type="info" }
  Le calendrier de l'avent est accessible et configurable du 25 novembre au 25 décembre.
::
...
|------|-------------|---------|
| **Rôle permanent** | Attribution d'un rôle Discord définitif | Rôle "Noël 2025" le 24 décembre |
