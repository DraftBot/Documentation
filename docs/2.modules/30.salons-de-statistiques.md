...
Lors de la configuration de la fonctionnalité en vous rendant dans la commande \</config> ➜ **"🧮 Salons de statistiques"**, vous aurez le choix entre deux designs :
...
![Résultat de la configuration](../assets/salons-de-statistiques/config_category_members.png)
...
![Aperçu d'un salon vocal de statistiques](../assets/salons-de-statistiques/bot_channelstats.png)
