...
contributors: ['bariboo', 'theorik', 'thecreatorn3ant']
...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    - "Couleur" ➜ Définir la couleur de la barre latérale de votre message de bienvenue. **_([<:icon_premium:1096140508625125417> premium](/premium))_**
    - "Image" ➜ Permet d'ajouter une image de fond à votre message de bienvenue. **_([<:icon_premium:1096140508625125417> premium](/premium))_**
...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    - "Couleur" ➜ Définir la couleur de la barre latérale de votre message d'au revoir. **_([<:icon_premium:1096140508625125417> premium](/premium))_**
    - "Image" ➜ Permet d'ajouter une image de fond à votre message d'au revoir. **_([<:icon_premium:1096140508625125417> premium](/premium))_**
