...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    ::hint{ type="info" }
      Vous pouvez configurer 1 réaction pour 10 mots. Les serveurs [premium](/premium) <:icon_premium:1096140508625125417> peuvent avoir jusqu'à 5 réactions pour un même mot, et n'ont pas de limite sur le nombre de mots.
    ::
