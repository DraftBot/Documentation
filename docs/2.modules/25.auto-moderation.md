...
::hint{ type="info" }
  Lorsque vous choisissez comme sanction automatique un **bannissement** *(permanent ou temporaire)*, vous pouvez aussi choisir la "**Suppression des messages**". Cela permettra de choisir si vous souhaitez supprimer les messages de l'utilisateur sur une certaine période *(Dernière heure, dernières 6 heures, dernières 12 heures, dernières 24 heures, derniers 3 jours ou derniers 7 jours)*.
::
