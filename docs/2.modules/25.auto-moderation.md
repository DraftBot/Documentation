...
::hint{ type="warning" }
  Si le blocage des mentions via **Discord** est activé, alors les mentions seront comptabilisées par **messages**, indépendemment du système proposé par DraftBot. De plus, les pings par **réponses** ne seront **pas comptabilisées**.
::
