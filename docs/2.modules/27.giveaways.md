...
La fonctionnalité de giveaways vous permet de lancer des concours aux membres de votre serveur.

<image d'un giveaway>

Ce système vous permet de définir un type de récompense par giveaway :
...
L'interface se découpe en page suivant le nombre de participants. Vous pouvez alors cliquer sur les boutons "Précédent" ou "Suivant".

::hint{ type="info" }
  - Vous pouvez également cliquer sur le bouton de page. Une interface s'ouvrira et vous demandera la page sur laquelle vous souhaitez accéder.
...
Les sous-commandes du \</giveaway> nécessite la permission **Administrateur** par défaut.
...
### Terminer prématurément un giveaway
