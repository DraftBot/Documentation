...
::tabs
  ::tab{ label="Depuis la commande /config" }
    Exécuter la commande \</config>, puis sélectionner depuis le menu déroulant `Signalements`.
...
::tabs
  ::tab{ label="Depuis la commande /config" }
    Exécuter la commande \</config>, puis sélectionner depuis le menu déroulant `Signalements` ➔ `Activer la réaction`.
  ::
...
::tabs
  ::tab{ label="Depuis la commande /config" }
    Exécuter la commande \</config>, puis sélectionner depuis le menu déroulant `Signalements` ➔ `Activer l'ouverture d'un fil`.
  ::
...
::tabs
  ::tab{ label="Depuis la commande /config" }
    Exécuter la commande \</config>, puis sélectionner depuis le menu déroulant `Signalements` ➔ `Rôle mentionné`.
  ::
...
::tabs
  ::tab{ label="Depuis la commande /config" }
    Exécuter la commande \</config>, puis sélectionner depuis le menu déroulant `Signalements` ➔ `Salon`.
  ::
...
::tabs
  ::tab{ label="Depuis la commande /config" }
    Exécuter la commande \</config>, puis sélectionner depuis le menu déroulant `Signalements` ➔ `Rôles modérateurs`.
  ::
...
::tabs
  ::tab{ label="Depuis la commande /config" }
    Exécuter la commande \</config>, puis sélectionner depuis le menu déroulant `Signalements` ➔ `Fil de tri`.
  ::
