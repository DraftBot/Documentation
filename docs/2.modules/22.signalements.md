...
contributors: ['rababio4579', 'ls62', 'elvhira']
...
### Tickets
Le système intègre également les tickets. Il permet d’ouvrir un ticket avec le membre signalé, ou le membre signalant, afin de discuter ou d’en savoir plus sur l'objet du signalement.
