...
Le salon de réception des tickets permet de recevoir les demandes de tickets des membres, qu'elles soient effectué via la commande \</ticket> ou bien via un **message d'ouverture**.
