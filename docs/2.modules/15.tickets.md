...
::tabs
  ::tab{ label="Activation via /config" }
    Si le système n'est pas encore configuré, le premier bouton sera gris et indiquera "Système désactivé".
    ...
    ![Décrivez l'image](../assets/tickets/commande_config_root.png)
  ::
