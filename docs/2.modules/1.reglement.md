...
Pour commencer, vous allez devoir effectuer la commande \</reglement créer>. **DraftBot** vous donnera ensuite la possibilité **d'ajouter le rôle** que vous souhaitez attribuer aux membres, ainsi que de **verrouiller** le rôle afin que les membres aient l'impossibilité de retirer le rôle.
...
::hint{ type="warning" }
  ...
  Pour savoir comment récupérer un identifiant en [**`cliquant ici`**](/docs/autres/recuperer-un-identifiant#identifiant-dun-message).
::
