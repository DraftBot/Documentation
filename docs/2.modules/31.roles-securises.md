...
::tabs
  ...
  ::tab{ label="Via la commande /config" }
    ...
    Lorsque vous appuyez sur "**Ajouter un accès**", 3 options s'offiront à vous :
...
::tabs
  ...
  ::tab{ label="Via la commande /config" }
    ...
    Lorsque vous ajouterez un lien automatique, voici les différentes options qui s'offiront à vous, modifiable à tout moment :
