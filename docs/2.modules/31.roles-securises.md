...
Pour configurer une sécurité par A2F via **DraftBot**, vous devez vous rendre dans le [panel de **DraftBot**](/dashboard/user/security), puis dans la section "**Sécurité**" de votre compte.

En haut de la page, vous trouverez la section dédiée à cet effet.

![Configuration de la sécurité par application d'authentification](../assets/roles-securises/panel_security_authentification.png)

Vous pourrez configurer un code A2F en appuyant sur "**Configurer**".

### Code PIN

Pour configurer une sécurité par code PIN via **DraftBot**, vous devez vous rendre dans le [panel de **DraftBot**](/dashboard/user/security), puis dans la section "**Sécurité**" de votre compte.

En haut de la page, vous trouverez la section dédiée à cet effet.

![Configuration de la sécurité par code PIN](../assets/roles-securises/panel_security_codepin.png)

Vous pourrez configurer un code PIN en appuyant sur "**Configurer**".

### Mot de passe

Pour configurer une sécurité par mot de passe via **DraftBot**, vous devez vous rendre dans le [panel de **DraftBot**](/dashboard/user/security), puis dans la section "**Sécurité**" de votre compte.

En haut de la page, vous trouverez la section dédiée à cet effet.

![Configuration de la sécurité par mot de passe](../assets/roles-securises/panel_security_password.png)

Vous pourrez configurer un mot de passe en appuyant sur "**Configurer**".
