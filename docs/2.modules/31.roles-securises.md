...
::tabs
  ::tab{ label="Via le panel" }
    ...
    ::hint{ type="info" }
      Vous pouvez sécuriser jusqu'à 2 rôles. Les serveurs [premium](/premium) <:icon_premium_:1096140508625125417> peuvent en sécuriser jusqu'à 10.
    ::
  ::
...
::tabs
  ::tab{ label="Via le panel" }
    ...
    ::hint{ type="info" }
      Vous pouvez sécuriser jusqu'à 10 membres. Les serveurs [premium](/premium) <:icon_premium_:1096140508625125417> peuvent en sécuriser jusqu'à 25.
    ::
  ::
...
::hint{ type="info" }
  Les fonctionnalités accompagnées de l'icône <:icon_premium:1096140508625125417> sont réservées aux serveurs [premium](/premium) <:icon_premium_:1096140508625125417>.
::
...
::tabs
  ::tab{ label="Via le panel" }
    ...
    ::hint{ type="info" }
      Vous pouvez créer jusqu'à 2 accès automatiques. Les serveurs [premium](/premium) <:icon_premium_:1096140508625125417> peuvent aller jusqu'à 10.
    ::
  ::
  ...
  ::tab{ label="Via la commande /config" }
    ...
    ::hint{ type="info" }
      Vous pouvez créer jusqu'à 2 accès automatiques. Les serveurs [premium](/premium) <:icon_premium_:1096140508625125417> peuvent aller jusqu'à 10 accès automatiques.
    ::
  ::
::
