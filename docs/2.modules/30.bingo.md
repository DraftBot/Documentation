...
Définissez une récompense optionellle pour motiver vos membres ! Plusieurs types sont disponibles :
...
- 💬 **Création de fil** : Option pour créer automatiquement un fil de discussion après la victoire pour rediriger le flux de membres afin que les membres puissent réagir au résultat du bingo.
