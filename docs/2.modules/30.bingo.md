...
Pendant la partie, des **indices** peuvent être donnés **manuellement par l'organisateur** via le [tableau de bord](#tableau-de-bord-admin) admin pour aider les joueurs à se rapprocher du nombre secret.
