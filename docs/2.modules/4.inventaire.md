...
- \</admininventaire retirer serveur> ➜ Retirer un objet de tous les inventaires du serveur.
...
::hint{ type="info" }
  **Opérations en masse** : Les commandes ciblant "un rôle" sont exécutées de manière **asynchrone**.
