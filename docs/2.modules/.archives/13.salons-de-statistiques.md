...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    Pour activer les salons vocaux temporaires, il vous suffira d'aller dans le menu **Salons de statistiques** de la commande /config et de cliquer sur le bouton **Créer un hub**.
  ::
