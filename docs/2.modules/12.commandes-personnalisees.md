  ...
  ::tab{ label="Inventaire / Économie" }
    ...
    *En utilisant cette commande, le membre achètera l'objet sélectionné.*
    ::collapse{ label="Afficher un exemple :" }
      ...
      ::hint{ type="info" }
        DraftBot vous laisse le champ libre pour les messages de confirmation :\
        💡Pensez à combiner cette action avec l'action **Envoyer un message** pour personnaliser l'expérience !
      ::
    ::
