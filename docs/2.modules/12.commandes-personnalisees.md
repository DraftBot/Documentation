...
::tabs
  ...
  ::tab{ label="Depuis le panel" }
    ...
    Pas de problème ! Cliquez sur "Modifier" ou "Supprimer", dans la colonne de droite.
    ![Boutons de modification ou suppression d'une commande personnalisée](../assets/commandes-personnalisees/edit_command_0.png){ with=300 }
    ::
  ::
::
