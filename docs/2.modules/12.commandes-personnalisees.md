...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    * Les rôles ou salons [interdits/autorisés](#restrictions),
    * Si la commande doit [apparaître](#masquage) dans le \</aide> ou non,
    * Si vous souhaitez ajouter un [mode lent](#mode-lent) à votre commande,
    * Si vous souhaitez définir une [condition](#conditions) pour l'utiliser.
