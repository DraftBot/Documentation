...
contributors: ['hugo-broc', 'clement669', 'theorik', 'elbaguetto', 'draftproducts', 'imroxxor']
  ...
  ::tab{ label="Message" }
    ...
    *Lors de l'exécution de la commande, DraftBot enverra un message.*
    ...
    ::collapse{ label="Afficher un exemple :" }
      ...
      ![Résultat de la commande sur Discord](../assets/commandes-personnalisees/panel_sended_message_example.png)
    ::
  ::
