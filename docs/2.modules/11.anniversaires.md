...
::tabs
  ::tab{ label="Rôle" }
    Vous pouvez permettre à vos membres d'acquérir des rôles. Pour ajouter un rôle aux cadeaux, sélectionnez le type **"rôle"**.
  ...
  ::tab{ label="Expérience"}
    Si le [système de niveaux](/docs/modules/niveaux) est activé, vous pouvez permettre à vos membres d'acquérir de l'expérience. Pour ajouter de l'expérience aux cadeaux, sélectionnez le type de **"Expérience"**.
  ...
  ::tab{ label="Cadeau Personnalisé" }
    ...
    Pour ajouter un cadeau personnalisé aux cadeaux, sélectionnez le type **"Un cadeau personnalisé"**.
