...
Le système d'anniversaire permet aux membres de partager leur anniversaire simplement. Grâce à cela vous pouvez leur offrir une attention particulière pour célebrer cette journée spéciale
...
::tabs
  ...
  ::tab{ label="Cadeau Personnalisé" }
    Si vous souhaitez offrir à vos membres autres choses, comme par exemple des codes promotionnels, des clés d'activation numériques, ou bien des objets "réels", DraftBot a la solution !
