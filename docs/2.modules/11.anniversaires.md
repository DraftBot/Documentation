...
- De l'expérience du [système de niveaux](/docs/modules/niveaux)
- De l'argent de l'[économie](/docs/modules/economie)
- Un objet d'[inventaire](/docs/modules/inventaire)
- Un objet personnalisé (notifié en mp)
