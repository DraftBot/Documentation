...
::tabs
  ::tab{ label="Rôle" }
    Vous pouvez permettre à vos membres d'acquérir des rôles. Pour ajouter un rôle aux récompenses, sélectionnez le type de récompense **"rôle"**.

    Choisissez ensuite le rôle à attribuer
  ...
  ::tab{ label="Expérience"}
    Si le [système d'expérience](/docs/modules/niveaux) est activé,vous pouvez permettre à vos membres d'acquérir de l'expérience. Pour ajouter de l'expérience aux récompense, sélectionnez le type de récompense **"Expérience"**.

    Choisissez ensuite le montant d'expérience à attribuer
  ::
  ...
  ::tab{ label="Argent" }
    ...
    Choisissez ensuite la somme d'argent à accorder.
  ::
