...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    ![Aperçu des options de personnalisation du système d'anniversaire via la commande /config](../assets/anniversaires/birthday_config_button.png)
    ...
    ![Aperçu des différents paramètres d'annonce d'anniversaire](../assets/anniversaires/birth_config_annoncement.png)
    ...
    ![Option rôle du menu de la configuration des anniversaires](../assets/anniversaires/birthday_config_role.png)
    ...
    ![Aperçu des options de configuration via le menu "Cadeaux"](../assets/anniversaires/birthday_config_gift.png)
    ...
    ![Option des cadeaux à offrir via le menu Cadeaux](../assets/anniversaires/bithday_config_option_gift.png)
    ...
    *Avec les deux boutons restant du menu des "Cadeaux", vous pouvez modifier et supprimer les paramètres enregistrés avec l'aide du premier bouton :*
    ...
    ![Aperçu des options du menu de configuration des annonces personnalisées](../assets/anniversaires/birthday_config_special_annoucement.png)

    - Premièrement, avec le bouton "Créer", vous pouvez accéder à deux options :

    ![Options disponibles pour la création d'une annonce personnalisée](../assets/anniversaires/birthday_config_premium_options.png)
  ...
  ::tab{ label="Depuis le panel" }
    ...
    ![Aperçu des boutons autorisés / interdits](../assets/anniversaires/birthday_config_role_access.png)
