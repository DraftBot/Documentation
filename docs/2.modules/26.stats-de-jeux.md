...
Certains jeux ne demande pas de pseudo, mais des **identifiants** ou des **TAG**.
...
::collapse{ label="Comment récupérer l'identifiant sur Branwlhalla" }
  Pour récupérer votre tag sur Brawlhalla, suivez ces étapes :

  - **Lancez Brawlhalla** : Ouvrez le jeu sur votre ordinateur via Steam ou une autre plateforme.

  - **Accédez à votre profil** : Une fois dans le jeu, recherchez votre nom d'utilisateur ou votre avatar, généralement situé dans un coin de l'écran principal. Cliquez dessus pour accéder à votre profil.

  - **Trouvez votre tag** : Dans votre profil, vous devriez voir votre tag, qui est une série unique de caractères associée à votre compte. Il est souvent situé près de votre nom d'utilisateur.

  - **Copiez le tag** : Si l'option est disponible, cliquez sur le tag pour le copier dans votre presse-papiers. Sinon, vous pouvez le noter manuellement.
::
...
### /stats clashofclans
Pour obtenir les différentes statistiques de clashroclashofclans, effectuez la commande \</stats clashofclans> et entrez le TAG de l’utilisateur ou mentionnez-le.
...
- **Préférences en guerre des clans** : Indique si le joueur est participe ou ne participe pas pour les guerres de clans.
...
### /stats clashroyale
Pour obtenir les différentes statistiques de clashroyale, effectuez la commande \</stats paladins> et entrez le TAG de l’utilisateur ou mentionnez-le.
