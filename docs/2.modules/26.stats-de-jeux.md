...
Vous avez la possibilité de partager vos pseudos de jeux ainsi de consulter les pseudos des autres utilisateurs avec la commande \</profil> en indiquant l'`utilisateur`.
...
### Comment récupérer les identifiants ou les TAG ?

::tabs
  ::tab{ label="Brawlhalla" }
