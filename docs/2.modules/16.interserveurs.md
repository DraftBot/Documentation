...
La fonctionnalité d'interserveurs permet à deux salons appartenant à des serveurs différents de communiquer entre eux. Grâce à une simulation créée par DraftBot, les messages sont transmis dans chaque salon comme s'ils étaient envoyés directement par leurs auteurs.

## Les commandes

**Trois commandes sont disponibles pour gérer les liaisons de salon :**
...
![Réponse de DraftBot lors de l'exécution de la commande](../assets/interserveurs/config_generate.png)
...
::hint{ type="info" }
  Vous pouvez configurer un seul interserveur. Les serveurs [premium](/premium) <:icon_premium_:1096140508625125417> n'ont pas de limite.
::
