...
::collapse{ label="Refuser une suggestion"}
  ...
  ::tabs
    ...
    ::tab{ label="commande" }
      La commande \</suggestmod refuser> vous permet également de refuser une suggestion. Vous devrez pour cela saisir l'[identifiant](/docs/autres/recuperer-un-identifiant#identifiant-dun-message) du message de la suggestion à refuser. Finalement, vous aurez la possibilité de donner une raison pour expliquer ce refus.
    ::
  ::
::
