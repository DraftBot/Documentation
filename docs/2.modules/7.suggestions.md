...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    ![Configuration des réactions, via la commande /config](../assets/suggestions/config_reactions2.png)
  ::
...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    ![Menu "confirmation", via la commande/config](../assets/suggestions/config_confirmation2.png)
  ::
...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    ![Menu "Modération", via la commande/config](../assets/suggestions/config_moderation2.png)
  ::
...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    ![Menu "Membres", via la commande/config](../assets/suggestions/config_membres2.png)
  ::
...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    *En plus des [autres variables](/docs/autres/variables) déjà disponibles globalement !*
    ...
    ![Menu "Fils de discussions automatiques", via la commande/config](../assets/suggestions/config_threads_auto2.png)
  ::
