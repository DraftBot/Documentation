...
contributors: ['bariboo', 'clement669', 'rababio', 'elbaguetto', 'imroxxor', 'draftproducts']
...
1. **Statut de suggestion** : Le statut que la suggestion occupe : acceptée, en attente, refusée, prévue
2. **Nombre de suggestion** : Le nombre déclencheur
