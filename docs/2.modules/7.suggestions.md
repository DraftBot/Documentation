...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    ![Bouton "Salon de réception" depuis la commande /config.](../assets/suggestions/config_channel.png)
  ::
...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    ![Menu "Limite par rôle", via la commande/config](../assets/suggestions/config_limite_role2.png)
  ::
...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    ![Bouton "Tri et recherche", via la commande/config](../assets/suggestions/config_sort_and_search.png)
  ::
...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    ![Création de récompense via /config](../assets/suggestions/config_rewards.png)
  ::
