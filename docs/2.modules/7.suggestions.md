...
Si vous souhaitez ajouter une image à votre suggestion, il suffit de déposer un fichier ou alors de cliquer sur le bouton "`parcours-les`" situé dans le panel "`Envoyer une suggestion`" de DraftBot (image ci-dessus).

![Message privé envoyé par DraftBot](../assets/suggestions/bot_upload_panel.png)
