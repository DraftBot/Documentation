...
![Message privé envoyé par DraftBot](../assets/suggestions/bot_upload_dm.png)
...
![Image uploadée en MP, et confirmation reçue](../assets/suggestions/bot_upload_success.png)
...
La commande \</suggestmod classement> ([premium](/premium) <:icon_premium_:1096140508625125417>) vous permet d’afficher un classement des suggestions, selon les critères suivants :
