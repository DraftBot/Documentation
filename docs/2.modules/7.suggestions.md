...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    **DraftBot** permet de mettre en place un **nombre de suggestions** autorisées sur une période définie (par exemple 1 suggestion toutes les 30 minutes, ou 3 par jour).

    ![Configuration du délai sur le panel](../assets/suggestions/panel_colors.png)
  ::
