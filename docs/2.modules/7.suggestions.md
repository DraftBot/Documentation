...
![Confirmation reçue après la réussite de l'upload](../assets/suggestions/ajouter_image_2.png)

Il ne vous reste plus qu'à retourner à la configuration pour valider votre suggestion, et elle apparaîtra avec l'image !

![suggestion finalisée, incluant une image et un commentaire](../assets/suggestions/suggestion_image_commentaire.png)
