...
La commande \</suggestmod classement> ([premium <:icon_premium_:1096140508625125417>](/premium)) vous permet d’afficher un classement des suggestions, selon les critères suivants :
...
La commande \</suggestmod rechercher> vous permet de rechercher des suggestions à partir de leur titre. ([premium <:icon_premium_:1096140508625125417>](/premium))
  ...
  ::tab{ label="Via la commande /config" }
    ...
    ::collapse{ label="Afficher le détail des informations sur le module"}
      ...
      ::collapse{ label="Fils de discussions automatiques"}
        ...
        ::hint{ type="info" }
          Il s'agit d'une [fonctionnalité premium <:icon_premium_:1096140508625125417>](/premium).
        ::
      ...
      ::collapse{ label="Limite de suggestions simultanées par rôle"}
        ...
        ::hint{ type="info" }
          Il s'agit d'une [fonctionnalité premium <:icon_premium_:1096140508625125417>](/premium). Si ce système est activé, il permet de configurer des limites spécifiques en fonction des rôles.
        ::
      ::
    ::
...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    - Modifier les couleurs ([Fonctionnalité premium <:icon_premium_:1096140508625125417>](/premium)).
  ...
  ::tab{ label="Via le Panel" }
    ...
    **DraftBot** permet de faire varier automatiquement la couleur d'une suggestion en fonction du ratio votes positifs / votes neutres / votes négatifs.
    ...
    ::hint{ type="info" }
      Les serveurs [premium <:icon_premium_:1096140508625125417>](/premium) peuvent personnaliser le dégradé utilisé pour indiquer la popularité d'une suggestion.
    ::
  ::
::
...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    ::hint{ type="info" }
      Cette fonctionnalité est réservée aux serveurs [premium <:icon_premium_:1096140508625125417>](/premium).
    ::
