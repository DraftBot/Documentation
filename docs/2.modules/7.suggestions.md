...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    - Des boutons d'action (nous y reviendrons dans le paragraphe suivant).
...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    ![Décrivez l'image](../assets/suggestions/config_activer_module.png)
  ::
...
::collapse{ label="Confirmation"}
  Ce bouton permet d'ouvrir le menu de configuration des confirmations. Dedans, vous pouvez :
  ...
  ![Menu "confirmations", via la commande/config](../assets/suggestions/commande_config_confirmation.png)
::

::collapse{ label="Modération"}
  Ce bouton permet d'ouvrir le menu de configuration de la modération des suggestions.

  Dedans, vous pouvez :
  - Définir si les suggestions pourront être traitées
  ...
  - Définir l'état par défaut des notifications, ou les désactiver
  ...
  ![Menu "confirmations", via la commande/config](../assets/suggestions/commande_config_moderation.png)
::

::collapse{ label="Membres"}
  Ce bouton permet d'ouvrir le menu de configuration des restrictions éventuelles à appliquer aux membres. En effet, vous pouvez :
  ...
  ![Menu "confirmations", via la commande/config](../assets/suggestions/commande_config_membres.png)
::

::collapse{ label="Fils de discussion automatiques"}

  ::hint{ type="info" }
    Fonctionnalité réservée aux serveurs sur lesquels [DratBot Premium](/premium) est activé.
  ::

  DraftBot peut créer automatiquement un fil de discussion attaché chaque suggestion, permettantà l'auteur de la suggestion, et aux modérateurs, d'interagir ensemble.
  ...
  ![Menu "confirmations", via la commande/config](../assets/suggestions/commande_config_fils_auto.png)
::

::collapse{ label="Limite par rôle"}

  ::hint{ type="info" }
    Fonctionnalité réservée aux serveurs sur lesquels [DratBot Premium](/premium) est activé.
  ::

  Cette fonction vous permet de restreindre les limites de suggestions simultanées en fonction des rôles.
  ...
  ![Menu "confirmations", via la commande/config](../assets/suggestions/commande_config_limite_role.png)
::
...
::collapse{ label="Limite par rôle"}
  ...
  Ce menu vous permet d'activer ou désactiver le [tri et la recherche des suggestions](#recherche-par-mots-clés).
::
