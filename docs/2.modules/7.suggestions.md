...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    Cette fonction vous permet d'activer l'indexation des suggestions pour rendre possible la [recherche avancée](#recherche-par-mots-cl%C3%A9) par critères (mots-clé, ratio de votes ...).
