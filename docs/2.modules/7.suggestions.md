...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    ![Création de récompense via /config](../assets/suggestions/config_recompenses.png)
  ::
  ...
  ::tab{ label="Via le panel" }
    ...
    ![Création de récompense depuis le panel](../assets/suggestions/panel_creer_recompense.png)
  ::
::
