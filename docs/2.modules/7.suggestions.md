...
## Recherche et classement des suggestions  ([✨ premium](https://www.draftbot.fr/premium))
...
### Recherche
La commande </suggestmod rechercher> vous permet de rechercher des suggestions à partir de leur titre.
...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    * "Mention activée par défaut" ➜ Une fois cette option activée, les membres seront notifiés lors du changement de statut.
  ...
  ::tab{ label="Via le panel" }
    ...
    * "Fils de tri" ➜ Une fois les suggestions [traitées](#gerer-une-suggestion), elles seront automatiquement placées dans les fils configurés ici.
