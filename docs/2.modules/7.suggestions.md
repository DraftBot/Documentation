...
contributors: ['bariboo', 'clement669', 'rababio', 'elbaguetto', 'imroxxor']
...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    ![Création de récompense via /config](../assets/suggestions/commande_config_annonce_recompenses.png)
  ::
