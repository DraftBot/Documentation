...
::hint{ type="info" }
  Une fois votre suggestion terminée, DraftBot vous affichera un message de confirmation. À ce moment là, vous pourrez modifier votre envoi, y ajouter une image, le valider, ou bien l'annuler :
