  ...
  ::tab{ label="Via la commande /config" }
    ...
    ::collapse{ label="Des boutons d'action"}
      ...
      ::collapse{ label="Fils de discussion automatiques"}
        ...
        ::hint{ type="success" }
          Vous pouvez personnaliser la nomenclature des fils en utilisant une des nombreuses [variables](../modules/commandes-personnalisees#les-variables) à votre disposition !
        ::
