...
::tabs
  ::tab{ label="Via la commande /config" }
    ...
    La personnalisation de l'emoji est réservée aux serveurs [premium](/premium) <:icon_premium_:1096140508625125417>.
...
- **Émoji** : Permet de modifier l'émoji par défaut du starboard (<:icon_premium_:1096140508625125417>)
