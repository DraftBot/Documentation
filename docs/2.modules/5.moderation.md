...
Grâce aux options de modération, vous pourrez décider de **masquer le nom du modérateur**, **envoyer un MP personnalisé selon la sanction**, **masquer les réponses aux commandes de modération** ou encore **d'afficher publiquement les sanctions**.
