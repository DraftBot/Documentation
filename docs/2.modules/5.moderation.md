...
Grâce aux options de modération, **vous pourrez décider de masquer le nom du modérateur, les réponses aux commandes de modération ou d'afficher publiquement les sanctions**.
...
::tabs
  ...
  ::tab{ label="Via la commande /config" }
    ...
    | Options | Description |
    |---------|-------------|
    | **Envoyer un MP lors d'une sanction** | Le membre sanctionné recevra un message privé avec les détails de la sanction |
    ...
    | **Affichage public des sanctions** | Lorsque cette option est activée, la commande \</sanctions lister> sera visible publiquement dans le salon au lieu d'être éphémère (visible uniquement par le modérateur) |
  ::
::
