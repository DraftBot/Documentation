...
Vous pouvez génerez des horaires dynamiques (timestamp) facilement avec le bouton <:timestamp:1389707186619285634>. Ces horaires s'adapteront de manière automatique aux fuseaux horaires des utilisateurs de votre serveur.
...
- **Titre :** Vous pouvez insérer le titre de votre embed. Vous pourrez également ajouter un lien facilement via le bouton <:title_link:1389707183377088572> qui apparaît quand vous écrirez.
...
::hint{ type="danger" }
  Votre message dans sa globalité ne peux pas contenir plus de `6000` caractères.
::
