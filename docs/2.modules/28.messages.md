...
- **Description :** C'est ici que vous pouvez mettre le corps de votre message. Le [Markdown Discord](https://support.discord.com/hc/fr/articles/210298617-Markdown-de-Texte-101-Formatage-du-chat-gras-italique-soulign%C3%A9) (**gras**, *italique*, etc.) est utilisable dans cette zone.<:logo_discord:1122414310023512074> est utilisable dans cette zone.
...
::collapse{ label="Envoyer un message sauvegardé" }
  ...
  - **Footer de l'embed :** Vous pouvez rajouter un petit texte en bas de votre embed. Pour créer un bouton interactif, il faut cliquer sur le bouton intitulé `Bouton`. Immédiatement, le menu permettant la configuration de votre bouton apparaîtra :  Pour qu'un message comportant une (ou des) interaction(s) fonctionne, il est **nécessaire** de l'enregistrer sur le panel.
