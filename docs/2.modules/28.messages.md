...
- **Footer de l'embed :** Vous pouvez rajouter un petit texte en bas de votre embed.Pour créer un bouton interactif, il faut cliquer sur le bouton intitulé `Bouton`. Immédiatement, le menu permettant la configuration de votre bouton apparaîtra :  Pour qu'un message comportant une (ou des) interraction(s) fonctionne, il est **nécessaire** de l'nregistrer sur le panel.
