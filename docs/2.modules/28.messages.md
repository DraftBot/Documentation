...
:tada: votre message a été envoyé selon vos paramétrages. Si c'est un message sans profil, vous pourrez le modifier sans avoir à la réenvoyer. En revanche si c'est un message avec profil, le message devra être renvoyé.
