...
contributors: ['tellvex', 'kazotka', 'ls62', 'theorik', 'rababio4579']
...
::hint{ type="warning" }
  Cet embed permet de modifier la visibilité, les accès ainsi que certaines permissions du salon et ce, sans permissions supplémentaires sur le serveur.
::
