...
Vous pouvez choisir précisément les options que vos membres peuvent modifier depuis le bouton **Réglages** de l'embed. Les quatre options disponibles sont :
