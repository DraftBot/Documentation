...
::tabs
  ...
  ::tab{ label="Depuis le panel" }
    Vous devez vous rendre sur le panel puis dans la catégorie [Communautaire](www.draftbot.fr/dashboard/first/community) puis `Salons vocaux temporaires (privateroom)`. puis vous cliquez sur le bouton `modifier`.
...
::collapse{ label="Liste des différentes permissions" }
  -
::
