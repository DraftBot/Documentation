...
### Rôles modérateurs
Les membres possédant un rôle modérateur auront **automatiquement accès à tous les salons vocaux temporaires** et ne pourront **pas être ajoutés à la liste noire** par le créateur du salon.
