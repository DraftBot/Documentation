...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    ![Bouton d'activation des récompenses depuis le panel](../assets/niveaux/panel_recompenses.png)

    1.[Créer une récompense](#creer_une_recompense) : cette option permet de créer et assigner des récompenses aux passages de niveaux de votre choix !

    ::collapse{ label="2. Configurer les annonces :" }
      Vous pouvez :
