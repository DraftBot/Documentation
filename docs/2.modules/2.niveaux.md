...
::tabs
  ...
  ::tab{ label="Via la commande /config" }
    ...
    ::collapse{ label="Expérience" }
      ...
      ![Menu "Expérience" via la commande /config](../assets/niveaux/config_exp.png)
    ::
    ...
    ::collapse{ label="Récompenses de niveaux" }
      ...
      ![Menu "Récompenses de niveau" via la commande /config](../assets/niveaux/config_recompenses.png)
    ::
    ...
    ::collapse{ label="Annonces" }
      ...
      ![Menu "Annonces" via la commande /config](../assets/niveaux/config_annonces.png)
    ::
    ...
    ::collapse{ label="Limitations & Boosts" }
      ...
      ![Menu "Limitations & Boosts" via la commande /config](../assets/niveaux/config_limit_boost.png)
    ::
    ...
    ::collapse{ label="Personnalisation" }
      ...
      ![Menu "Personnalisation" via la commande /config](../assets/niveaux/config_personnalisation.png)
    ::
