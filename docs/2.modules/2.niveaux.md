...
| **Exponentielle** | Croissante rapide | La difficulté augmente de manière exponentielle, les hauts niveaux sont beaucoup plus difficiles à atteindre |
...
::tabs
  ...
  ::tab{ label="Via la commande /config" }
    ...
    ::collapse{ label="Récompenses de niveaux" }
      ...
      ![Menu "Récompenses de niveau" via la commande /config](../assets/niveaux/config_bot_rewards.png)
    ::
...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    ![Menu des récompenses depuis le Panel DraftBot](../assets/niveaux/panel_bot_rewards.png)
  ...
  ::tab{ label="Via la commande /config" }
    ...
    ![Menu "Récompenses" via la commande /config](../assets/niveaux/config_bot_rewards.png)
  ::
::
...
![Menu de création de récompenses, depuis le panel](../assets/niveaux/panel_creation_recompense.png)
