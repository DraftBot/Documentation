...
contributors: ['hugo-broc', 'wernouxe', 'rababio4579', 'lepirateytb']
...
- \</dropxp> ➜ Créer un message qui offre de l'expérience au premier qui clique sur le bouton.

Après avoir choisit le montant, deux options facultatives supplémentaires s'offre à vous :
