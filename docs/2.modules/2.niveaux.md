...
::tabs
  ...
  ::tab{ label="Via la commande /config" }
    ...
    ![Menu "Récompenses" via la commande /config](../assets/niveaux/config_recompenses_lvl.png)
  ::
::
...
::collapse{ label="En entrant la commande /topniveau sur discord" }
  ...
  ![Résultat de la commande /topniveau](../assets/economie/commande_topniveau.png)
  ...
  ::hint{ type="success" }
    ...
    ![Résultat de la commande /topniveau top 10](../assets/economie/topniveau10.png)
  ::
::
