...
Il peut s'agir de rôles (temporaires ou non), d'argent du [système d'économie](/docs/modules/economie), d'[objets d'inventaire](/docs/modules/inventaire), et même de récompenses personnaliszefzefzeféeees !

![Décrivez l'image](../assets/niveaux/recompenses.png)
...
L'expérience peut être gagné de diverses manières, la plus répandue est la **participation écrite** dans le serveur. Être actif sur le serveur vous fait monter en niveau. Chaque message dans une fenetre de 30 secondes rapporte une quantité d'expérience endacrée entre deux nombres configurés (15 à 25xp par défaut).

Grâce à l'**écosystème** de DraftBot, il vous sera possible de donner de faire gagner de l'expérience aux membres de plein d'autres manières : Giveaways, Boutique, Cadeaux d'anniversaires, Drop d'expérience dans les salons et Calendrier de l'avent.

Les serveurs [premium](/premium), pourront profiter d'un gain d'expérience en fonction de l'**activité vocal** : Chaque membre en vocal considéré comme actif, gagnera une quantité d'expérience endacrée entre deux nombres configurés (15 à 25xp par défaut) toutes les 2 minutes.
...
Conditionné par un niveau minimum, les annonces seront envoyés dans un salon spécifique pour ne pas déranger la conversation ou directement dans le salon actif afin de donner de permettre à tout le monde de fêter ce gain de niveau.
...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    Ensuite, l'ensemble des [fonctionnalités](#f#fonctionnalités-disponibles) apparaît :
