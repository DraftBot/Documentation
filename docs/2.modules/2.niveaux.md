...
Les serveurs [premium](/premium) <:icon_premium:1096140508625125417> peuvent activer le gain d'expérience en fonction de l'**activité vocale**. Chaque membre actif en vocal gagne une quantité d'expérience aléatoire (15 à 25 XP par défaut, configurable) **toutes les 2 minutes**.
