...
### Expérience en vocal <:icon_premium:1096140508625125417>
...
Les serveurs [premium](/premium) peuvent définir un **niveau maximum** pour plafonner la progression. Une fois ce niveau atteint, les membres **ne gagnent plus aucune expérience** jusqu'à ce que le plafond soit relevé ou supprimé. L'XP gagnée pendant cette période n'est pas comptabilisée rétroactivement.
...
::tab{ label="Argent" }
  ...
  Choisissez :
  - Le niveau requis
  - La somme d'argent à accorder (jusqu'à 1 000 milliards)
