...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    ::hint{ type="success" }
      Si vous avez déjà configuré des [articles de boutique](/docs/modules/economie#créer-un-article-de-boutique), ils apparaîtront en bas de l'écran, et vous pourrez les modifier / supprimer.
    ::
  ::
