...
Il est possible de mettre un place dans un salon dédié un classement des membres en temps réel et mis à jour automatiquement.
...
L'expérience peut être gagnée de trois façons :

### Gain par écrit

La manière la plus répandue est la **participation écrite** dans le serveur. Chaque message dans une fenêtre de 30 secondes rapporte une quantité d'expérience comprise entre deux valeurs configurées (15 à 25xp par défaut).

### Gain en vocal

Une autre manière consiste à faire profiter d'un gain d'expérience en fonction de l'**activité vocale** : Chaque membre en vocal considéré comme actif, gagnera une quantité d'expérience comprise entre deux valeurs configurées (15 à 25xp par défaut) toutes les 2 minutes.
