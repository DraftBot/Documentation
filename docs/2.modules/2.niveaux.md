...
| **Linear** | Croissante modérée | Chaque niveau nécessite progressivement plus d'XP de manière linéaire |
| **Exponential** | Croissante rapide | La difficulté augmente de manière exponentielle, les hauts niveaux sont beaucoup plus difficiles à atteindre |
