...
| **Personnalisation de la couleur** | Changez la couleur des embeds et cartes de niveau (option premium <:icon_premium_:1096140508625125417>) |
...
| **Custom** <:icon_premium_:1096140508625125417> | Personnalisée | Définissez votre propre formule (réservé aux serveurs premium) |
...
::hint{ type="info" }
  ...
  **Couleur personnalisée** <:icon_premium_:1096140508625125417> : Les serveurs premium peuvent changer la couleur de l'embed d'annonce.
::
...
::tabs
  ...
  ::tab{ label="Via la commande /config" }
    ...
    ::collapse{ label="Expérience" }
      ...
      - Activer / Désactiver / Régler l'expérience reçue en vocal (<:icon_premium_:1096140508625125417>)
    ...
    ::collapse{ label="Personnalisation" }
      Ce menu propose des personnalisations exclusives réservées aux [serveurs premium](/premium) <:icon_premium_:1096140508625125417> :
