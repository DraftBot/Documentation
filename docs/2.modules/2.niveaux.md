...
Pour les serveurs [premium](/premium) <:icon_premium_:1096140508625125417>, il est possible de mettre un place dans un salon dédié un classement des membres en temps réel et mis à jour automatiquement.
...
Les serveurs [premium](/premium) <:icon_premium_:1096140508625125417> pourront profiter d'un gain d'expérience en fonction de l'**activité vocale** : Chaque membre en vocal considéré comme actif, gagnera une quantité d'expérience comprise entre deux valeurs configurées (15 à 25xp par défaut) toutes les 2 minutes.
