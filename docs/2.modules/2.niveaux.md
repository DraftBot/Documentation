...
| \</adminxp ajouter tous> | Ajouter de l'expérience à **tous les membres** du serveur (opération asynchrone). |
| \</adminxp ajouter vers> | Ajouter de l'expérience à tous les membres ayant un **rôle spécifique** (opération asynchrone). |
...
| \</adminxp retirer tous> | Retirer de l'expérience à **tous les membres** du serveur (opération asynchrone). |
| \</adminxp retirer vers> | Retirer de l'expérience à tous les membres ayant un **rôle spécifique** (opération asynchrone). |
