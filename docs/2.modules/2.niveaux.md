...
![Récompenses de niveau](../assets/niveaux/recompenses.png)
...
Conditionné par un niveau minimum, les annonces seront envoyées dans un salon spécifique pour ne pas déranger la conversation ou directement dans le salon actif afin de donner de permettre à tout le monde de fêter ce gain de niveau.
