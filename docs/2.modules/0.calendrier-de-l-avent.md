...
::tabs
  ...
  ::tab{ label="Expérience" }
    Si le [système de niveaux](/docs/modules/niveaux) est activé sur votre serveur, vous pouvez récompenser vos membres avec de l'expérience.
  ...
  ::tab{ label="Objet Inventaire" }
    Récompensez vos membres avec des [objets d'inventaire](/docs/modules/inventaire) personnalisés.
...
Récompensez la régularité de vos membres grâce le système d'ouvertures consécutives ! Les membres qui ouvrent leur case chaque jour sans interruption peuvent recevoir des récompenses bonus.
...
Les serveurs [premium](/premium) <:icon_premium_:1096140508625125417> peuvent définir une image de fond personnalisée (10 Mo maximum).
