...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    Pour activer le module, la première étape est de faire la configuration rapide :

    ![Activation de la Route de l'Infini depuis le Panel](../assets/route-infini/panel_setup.png)
