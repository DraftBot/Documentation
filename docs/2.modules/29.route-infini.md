...
| **Commande envoyée** | Toute commande envoyée est comptabilisée comme une erreur |

::hint{ type="info" }
  Le système détecte aussi une erreur lorsqu'un utilisateur fait une commande dans le salon configuré.
::
