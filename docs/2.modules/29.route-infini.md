...
- **Consécutif** : Vous pouvez envoyer entre 2 et 20 nombres d'affilée avant que le message d'erreur ne s'envoie.
...
Avec cette option, vous pouvez configurer :
- **La récompense** : L'argent, l'xp, un objet d'inventaire, autre chose
- **le palier** : Le nombre à atteindre pour obtenir la récompense
