...
Vous souhaitez ajouter un effet de surprise à vos membres, alors les récompenses mystères vous permettent de cacher les récompenses que vous souhaitez attribuer a vos membres et de la remplacer par ":gift: Récompense mystère"
...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    Commencer ensuite par créer une récompense.
    Quand vous sélectionnerez le type de récompense, une nouvelle option apparaît : « Masquer dans /route-infini ».
  ...
  ::tab{ label="Via la commande /route-infini" }
    Si vous êtes un animateur de la route de l'infini ou un administrateur, vous pourrez appuyez sur le bouton "gérer les récompenses"
    De là, vous pourrez :
