...
contributors: ['imroxxor', 'rababio4579', 'deluccaromuald-ops']
updatedAt: '2026-08-12'
---

## Qu'est-ce que la Route de l'Infini ?

La route de l'infini est un système de comptage collaboratif sur votre serveur. Elle consiste à ce que vos membres envoient des nombres dans un salon dédié, en respectant une suite numérique continue.
...
Le système détecte automatiquement trois types d'erreurs. Vous pouvez ensuite choisir pour **quels types d'erreurs** appliquer des actions supplémentaires (réinitialisation, retrait d'argent, rôle temporaire).
