...
- **Alternance** : Vous ne pouvez pas envoyer deux nombres consécutifs. Un autre membre doit compter entre vos deux messages
- **Consécutif** : Vous pouvez envoyer entre 2 et 20 nombres d'affilés avant que le message d'erreur ne s'envoie
