...
Pour configurer DraftBot, aller dans les paramètres de **votre serveur** Discord puis dans la catégorie **Intégrations**. Vous y trouverez tous les bots de votre serveur, y compris DraftBot. **Cliquez** sur DraftBot pour afficher toutes ses commandes.
...
::hint{ type="info" }
  Certaines commandes requièrent une permission Discord particulière pour y avoir accès. M
::
