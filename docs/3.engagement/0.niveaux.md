...
| **Personnalisée** <:icon_premium:1096140508625125417> | Au choix | Définissez votre propre formule de progression |
...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    ![Module Niveaux activé sur le Panel](../assets/niveaux/panel_home.png)
