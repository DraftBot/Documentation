...
::tabs
  ::tab{ label="Depuis le panel" }
    ...
    **Montant aléatoire :** Un montant aléatoire permet de fixer un montant journalier compris **entre deux nombres** chaque jour. Ce nombre est choisi entre un **montant minimum** et un **montant maximum**, et sera **entier**.
