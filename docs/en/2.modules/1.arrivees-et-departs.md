...
::tabs
  ::tab{ label="Via the /config command" }
    ...
    ::collapse{ label="Variable" }
      A variable is a piece of text that changes depending on the person, the server, the channel, or even the time. Here are the ones you can use in DraftBot's welcome messages.
...
::tabs
  ::tab{ label="Via the /config command" }
    ...
    ::collapse{ label="Variables" }
      Variables are pieces of text that change depending on the person, the server, the channel, or even the time. Here are the ones you can use in DraftBot's goodbye messages.
