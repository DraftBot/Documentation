...
![Configuration du filtre de vocabulaire sur le panel web de DraftBot](<../.gitbook/assets/image (56).png>)
...
![Configuration de l'anti-invitation Discord via le panel web](<../.gitbook/assets/image (57).png>)
...
![Configuration des liens externes via le panel web](<../.gitbook/assets/image (48).png>)
...
![Interface de modération avec la commande sanction](<../.gitbook/assets/image (40).png>)
...
| :----------------------------------------------------------------: | :----------------------------------------------------------------: |
| <p></p><p><img src="../.gitbook/assets/image (26).png" alt=""></p> | <p></p><p><img src="../.gitbook/assets/image (28).png" alt=""></p> |
